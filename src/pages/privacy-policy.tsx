export default function privacypolicy() {
	return (
		<>
			...
			<p>
				gdscwow built the GDSC WoW app as a Free app. This SERVICE is provided by gdscwow at no cost and is intended for
				use as is.
			</p>{' '}
			<p>
			...
			<p>
				...
				accessible at GDSC WoW unless otherwise defined in this Privacy Policy.
			</p>{' '}
			<p>
			...
			<p>
				...
				identifiable information, including but not limited to email, full-name, location, contact information. The
